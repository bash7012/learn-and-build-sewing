...
- [ ] Decide when to draft from the block
- [ ] Decide when to grade an existing pattern between sizes
- [ ] Decide when to trace something that already works
- [ ] Write the rule that actually works after trying both onesie branches

## Tweaking or outlining an existing pattern between grades
...
- [ ] Length
- [ ] Shoulder
- [ ] Crotch or rise if relevant
- [ ] Ease

### What to change on the paper

- [ ] Blend between sizes where needed
- [ ] True the seams after blending
- [ ] Write down every move
- [ ] Do not average a point that is a full size off
...
- [ ] Plan how to trace without taking the garment apart for real
...
- [ ] Mark where it has grown out of
- [ ] Carry surviving changes onto the paper pattern to cut from
...
- Aldrich for grading between children's sizes and for using a block as the reference.
- Reader's Digest for working from an existing garment and for basic pattern alteration habits.
- See also the [baby onesie](/items/baby-onesie/) for both approaches on one garment.
